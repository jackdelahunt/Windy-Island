...
const float WIND_STRENGTH_MULTIPLIER = 1.0;
...
void main() {
    ...
    float wind_strength = (texture(u_wind_texture, wind_uv).r * 2.0) - 1.0; // wind for a given vertex is -1 -> 1
...
const vec3 DEFAULT_WIND_COLOUR = vec3(0.6, 0.95, 0.7);
